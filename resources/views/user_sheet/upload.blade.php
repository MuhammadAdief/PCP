    ...
    <div class="card">
        ...
        <div class="card-header">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ url('user_sheet') }}" class="btn btn-primary"
        ...
        <div class="card-body">
            ...
            <form id="fileUploadForm" action="{{ route('user_sheet.file.upload') }}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="sheet_code" id="sheet_code" class="form-control" required
                                value="{{ old('sheet_code', session('sheet_code')) }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-center mt-3">
                    <div class="btn-group" role="group">
                        <button type="submit" name="action" value="preview" class="btn btn-primary"
                            style="background-color: #f0f0f0; color:#191970; border: 2px solid #191970; font-weight:500; border-radius: 10px 0px 0px 0px; margin-right: 3px;">Preview</button>

                        <button type="submit" name="action" value="upload" class="btn btn-primary"
                            style="color:black;background-color: #f0f0f0; border: 2px solid #191970; font-weight:500; border-radius: 0px 10px 0px 0px;">Upload</button>
                    </div>
                </div>
            </form>
            ...
            <div class="d-flex justify-content-center mt-4">
                <button id="resetButton" class="btn btn-warning"
                    style=";background-color: #191970;color:white; border: 0; border-radius: 0px 0px 10px 10px; margin-top:-15px; width:163px">Reset</button>
            </div>
        </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach(session('previewData')[0] as $row)
                                    <tr>
                                        @foreach($row as $cell)
                                            <td>{{ htmlspecialchars(is_string($cell) ? $cell : 'N/A', ENT_QUOTES, 'UTF-8') }}</td>
                                        @endforeach
                                    </tr>
                                @endforeach
                            </tbody>
...
<style>
    ...
    .table thead th {
        ...
        /* Adjust to match your card header color */
        z-index: 1;
    }
