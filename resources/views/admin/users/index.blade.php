        ...
        <form method="POST" action="{{ route('admin.logout') }}" style="margin: 0;">
            <div class="btn-group" role="group" style="border: 0;">
                ...
                <button 
                    ...
                    style="background-color: #03346E; border-radius: 0 10px 0px 0; border: none;"
                >
                    {{ __('Log Out') }}
                </button>
            </div>
...
<form method="GET" action="{{ route('admin.users.index') }}" class="mb-4 d-flex align-items-center" >
    ...
    <div class="btn-group" role="group" style="border: 0ch">
        <button type="submit" class="btn btn-primary" style="border-radius: 15ch; margin-right: 6px; border: 0ch; background-color:#b0b0b0">Search</button>
        <a href="{{ route('admin.users.index') }}" class="btn btn-secondary" style="border-radius: 15ch; border: 0;background-color:#03346E">Reset</a>
    </div>
                                                ...
                                                <form method="POST" action="{{ route('admin.users.remove-role', [$user, $role]) }}" class="role-form">
                                                    ...
                                                    <span class="role-badge">
                                                        ...
                                                        <button type="submit" class="remove-role-btn">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 1024 1024" fill="#03346E"><path d="M512 897.6c-108 0-209.6-42.4-285.6-118.4-76-76-118.4-177.6-118.4-285.6 0-108 42.4-209.6 118.4-285.6 76-76 177.6-118.4 285.6-118.4 108 0 209.6 42.4 285.6 118.4 157.6 157.6 157.6 413.6 0 571.2-76 76-177.6 118.4-285.6 118.4z m0-760c-95.2 0-184.8 36.8-252 104-67.2 67.2-104 156.8-104 252s36.8 184.8 104 252c67.2 67.2 156.8 104 252 104 95.2 0 184.8-36.8 252-104 139.2-139.2 139.2-364.8 0-504-67.2-67.2-156.8-104-252-104z" /><path d="M707.872 329.392L348.096 689.16l-31.68-31.68 359.776-359.768z" /><path d="M328 340.8l32-31.2 348 348-32 32z" /></svg>
                                                        </button>
                                                    </span>
                                                </form>
                                            @endforeach
                                ...
                                <td class="button-cell center-content" style="padding-top:15px;padding-bottom:-20px">
                                    <form method="POST" action="{{ route('admin.users.assign-role', $user) }}" class="assign-role-form">
                                        ...
                                        <div class="input-group">
                                            <select name="role" required class="form-select" style="background-color: #f9f9f8; color: black; border-radius: 0%; font-size: 14px; box-shadow: inset 0 0 0 2px #03346E;">
                                            ...
                                            <button type="submit" class="btn" style="border: solid 1px #b0b0b0; background-color: #f9f9f8; box-shadow: inset 0 0 0 2px #03346E;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24">
                                                    <path d="M24 9h-9v-9h-6v9h-9v6h9v9h6v-9h9z" fill="#03346E"/>
                                                </svg>
                                            </button>
                                        </div>
                                    </form>
...
.role-badge {
    ...
    box-shadow: inset 0 0 0 2px #03346E;
    border-radius: 4px;
    padding: 0.35rem;
    display: flex;
    align-items: center;
